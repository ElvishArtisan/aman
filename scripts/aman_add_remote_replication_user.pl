...
# aman_add_remote_replication_user.pl
#
#  Add MySQL Remote Replication User Login for Aman
#
...
ReadMode(0);
print "\n";
my $remote_address=GetLine("IP Address of remote server","");
...
# Add Users
#
$sql="insert into `user` set `Host`='".$remote_address."',".
    "`User`='".$repl_username."',".
